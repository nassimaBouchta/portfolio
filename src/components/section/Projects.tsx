...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Konane Game",
      description: "A hawaian board game, two players, 7*7 grid. The winner is the one who's left with legal moves while his opponent is stuck",
      technologies: ["C"],
      icon: comingSoon,
    ...
    {
      title: "Comaraison between random number generators BBS and LCG",
      description: "Implementation the random number generator BBS and LCG, implemetations of tests of primality, and tests of speed and security of these two PRNGs",
      technologies: ["Python", "matplotlib", "numpy", "Math","Random"],
      icon: comingSoon,
